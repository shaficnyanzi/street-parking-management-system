...
<html lang="en">
  <head>
    ...
    <title>PARKINGA WEB PORTAL</title>
    <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body>
    <div >
      <div class="container">
         ...
         <div class="col-md-8">
                 <center><h1 class="colors"><a href="home.php" style="text-decoration: none; color:white;">PARKINGA  MANAGEMENT PORTAL</a></h1></center>
           ...
           <ul>
             ...
             <li class="list-group-item" >
               <select class="form-control" onchange="filter_park()" id="city">
                 <option value="Mombasa">kampala</option>
             ...
             <li class="list-group-item">
               <select class="form-control" onchange="filter_park()" id="street">
                 ...
                 <option value="Tudor">Oboja</option>
             ...
             <li class="list-group-item" id="requests"><a href="navigation.php"><span class="glyphicon glyphicon-map"></span> Navigation</a></li>

...
<html lang="en">
  <head>
    ...
    <title> PARKINGA STREET WEB PORTAL</title>
    <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
$(".modal-transparent").on('hidden.bs.modal', function () {
      ...
      <div class="container">
         ...
         <div class="col-md-4">
               <div class="page-header">
                 <center><h1 class="colors"> PARKINGA STREET Portal</h1></center>
               </div>
         </div>
         <div class="col-md-4"></div>
      </div>
  ...
  <div class="form-group">
      ...
      <input type="text" phone_number="name" id="phone"  class="text ui-widget-content ui-corner-all">
  </div>  
         ...
         <div class="col-md-4">
           ...
           <form enctype="multipart/form" action="index.php" method="POST" id="">
             ...
             <button type="submit" name="login">login</button>
              ...
              <ul>
                  <li><a  href="attendant_login.php">Login as attendant</a></li>
              </ul>
              <ul>
                  <li><a  href="admin_login.php">Login as admin</a></li>
              </ul>
              
              <li class="list-group-item" id="requests"><a href="userforgottenpass.php"><span class="glyphicon glyphicon-map"></span> Forgotten password</a></li>
           </form>
